...
<form method="<?= $vars['method'] ?>" action="<?=$vars['action']?>">
    ...
    <div class="container mt-5">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-12">
            <input type="text" min-height="500px" name="info" placeholder="About" 
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <input type="text" step="1" name="start_year" placeholder="Started in" 
                value="<?= isset($vars['education']) ? $vars['education']->start_year : '' ?>" />
            </div>
            <div class="col-md-6">
                <input type="text" step="1" name="end_year" placeholder="Completed in" 
