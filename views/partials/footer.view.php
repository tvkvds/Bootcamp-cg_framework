...
<div class="row">
    ...
    <div class="col-2">
        ...
        <a href="/education" class='mx-3 row'>All my educations</a>
    ...
    <div class="col-2">
        ...
        <a href="/job" class='mx-3 row'>All my jobs</a>
    ...
    <div class="col-2">
        ...
        <a href="/skill" class='mx-3 row'>All my skills</a>
        <a href="/skill/<?=$_SESSION['user']['uid']?>/create" class='mx-3 row'>New Job</a>
    
    </div>
    <div class="col-2">
        <h6 class="m-3 row">Project</h6>

        <a href="/project" class='mx-3 row'>All my projects</a>
    ...
    <div class="col-2">
        ...
        <a href="/hobby" class='mx-3 row'>All my hobbies</a>
