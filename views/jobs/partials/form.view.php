    ...
    <div class="container mt-5">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                value="<?= isset($vars['jobs']) ? $vars['jobs']->role : '' ?>">
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                value="<?= isset($vars['jobs']) ? $vars['jobs']->company : '' ?>">
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                value="<?= isset($vars['jobs']) ? $vars['jobs']->responsibilities : '' ?>">
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-3 mb-3">
                ...
                value="<?= isset($vars['jobs']) ? $vars['jobs']->start_year : '' ?>">
            </div>

            <div class="col-md-3">
                <input type="text" name="end_year" placeholder="Ended in" 
                value="<?= isset($vars['jobs']) ? $vars['jobs']->end_year : '' ?>">
            </div>
        ...
        <input type="hidden" name="id" value="<?= isset($vars['jobs']) ? 
        $vars['jobs']->id : '' ?>">
